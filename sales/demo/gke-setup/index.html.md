...
title: "Set up your own GitLab CE or EE instance on Google Container Engine"
---
...
container cluster. Today I'm going to use Google Cloud Platform, which includes
Container Engine, a Kubernetes platform hosted by Google.
...
zone. I’ll leave it at 3 nodes, but bump up the machine type to have 2 virtual
CPUs for performance reasons.
...
> * `helm upgrade -i makesiddance --namespace gitlab --set baseDomain=makesiddance.com,externalIP=104.198.192.151,legoEmail=you@gitlab.com,provider=gke gitlab/gitlab-omnibus` (Replacing baseDomain, externalIP, and legoEmail as appropriate.)
>
...
helm upgrade -i makesiddance --namespace gitlab --set baseDomain=makesiddance.com,externalIP=104.198.192.151,legoEmail=you@gitlab.com,provider=gke,gitlab=ee,gitlabEELicense=$LICENSE gitlab/gitlab-omnibus
```
...
cycle analytics to measure how fast you’re going from idea to production, and
